        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover the powerful features that make CampusVote the leading choice for secure campus elections.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
              ...
              <p className="text-gray-600">
                End-to-end encryption ensures every vote is secure and tamper-proof.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
              ...
              <p className="text-gray-600">
                Instant vote counting and live result updates for transparent elections.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
              ...
              <p className="text-gray-600">
                Vote from any device with our responsive mobile-first design.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
              ...
              <p className="text-gray-600">
                Comprehensive analytics and reporting for election insights.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
              ...
              <p className="text-gray-600">
                Support for multiple languages to reach diverse campus communities.
              </p>
            </div>
